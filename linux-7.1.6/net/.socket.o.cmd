...
$(deps_net/socket.o):
#SYMVER sock_alloc_file 0x6554a70f
#SYMVER sock_from_file 0x41162cd5
#SYMVER sockfd_lookup 0xa4924aa6
#SYMVER sock_alloc 0x31b3687a
#SYMVER sock_release 0x01e866c2
#SYMVER __sock_tx_timestamp 0x35f01dd5
#SYMVER sock_sendmsg 0xe1471946
#SYMVER kernel_sendmsg 0xe2aa6375
#SYMVER __sock_recv_timestamp 0x3ea28eda
#SYMVER __sock_recv_wifi_status 0x85fc1178
#SYMVER __sock_recv_cmsgs 0x0ba28487
#SYMVER sock_recvmsg 0x0e185dd6
#SYMVER kernel_recvmsg 0x437085dc
#SYMVER brioctl_set 0x190daa85
#SYMVER vlan_ioctl_set 0x440f149c
#SYMVER sock_create_lite 0xaa33f04c
#SYMVER sock_wake_async 0x93c85021
#SYMVER __sock_create 0x54355985
#SYMVER sock_create 0xf1895953
#SYMVER sock_create_kern 0xb48c02c4
#SYMVER do_sock_setsockopt 0x9e0bbb76
#SYMVER do_sock_getsockopt 0xf0c80f8e
#SYMVER sock_register 0x829fed7b
#SYMVER sock_unregister 0x62737e1d
#SYMVER get_user_ifreq 0x33fc2a31
#SYMVER put_user_ifreq 0x38f48af7
#SYMVER kernel_bind 0x9b6bd7c1
#SYMVER kernel_listen 0x2e103dc7
#SYMVER kernel_accept 0xe09e103c
#SYMVER kernel_connect 0x93c359dc
#SYMVER kernel_getsockname 0x796bac63
#SYMVER kernel_getpeername 0xd2dde249
#SYMVER kernel_sock_shutdown 0xb71c0948
#SYMVER kernel_sock_ip_overhead 0x172ce34a
