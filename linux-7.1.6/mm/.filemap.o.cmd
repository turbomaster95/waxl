...
$(deps_mm/filemap.o):
#SYMVER filemap_check_errors 0xd08c7d4e
#SYMVER filemap_fdatawrite_range 0x652542d2
#SYMVER filemap_fdatawrite 0x07cabb3b
#SYMVER filemap_flush_range 0x2c2b08b3
#SYMVER filemap_flush 0xd275e8a7
#SYMVER filemap_flush_nr 0x74f5a3f3
#SYMVER filemap_range_has_page 0x3c72eeb4
#SYMVER filemap_fdatawait_range 0x67acdff7
#SYMVER filemap_fdatawait_range_keep_errors 0xccdb770b
#SYMVER file_fdatawait_range 0x0edc6e1a
#SYMVER filemap_fdatawait_keep_errors 0x6a6abcef
#SYMVER filemap_range_has_writeback 0xebdd4d2a
#SYMVER filemap_write_and_wait_range 0x32320a98
#SYMVER __filemap_set_wb_err 0x23b8df00
#SYMVER file_check_and_advance_wb_err 0xebd5b1a4
#SYMVER file_write_and_wait_range 0x5db75fc0
#SYMVER replace_page_cache_folio 0x971af2b5
#SYMVER filemap_add_folio 0xbe4b7298
#SYMVER filemap_invalidate_lock_two 0xbc8c1eb9
#SYMVER filemap_invalidate_unlock_two 0x20415185
#SYMVER folio_wait_bit 0xe5fcdc48
#SYMVER folio_wait_bit_killable 0xb1868525
#SYMVER folio_unlock 0x94d48b12
#SYMVER folio_end_read 0xa738c875
#SYMVER folio_end_private_2 0xcd1b3dcc
#SYMVER folio_wait_private_2 0x7c245e5b
#SYMVER folio_wait_private_2_killable 0xbddabbaf
#SYMVER folio_end_dropbehind 0x3a87644e
#SYMVER folio_end_writeback_no_dropbehind 0x80133108
#SYMVER folio_end_writeback 0x19cccddc
#SYMVER __folio_lock 0x899c88b0
#SYMVER __folio_lock_killable 0xf15450e5
#SYMVER page_cache_next_miss 0xa3b7d20d
#SYMVER page_cache_prev_miss 0xa275d57d
#SYMVER __filemap_get_folio_mpol 0xe187ca91
#SYMVER filemap_get_folios 0x05ecbb09
#SYMVER filemap_get_folios_contig 0x25afa1b8
#SYMVER filemap_get_folios_tag 0x0833c5fc
#SYMVER filemap_read 0x6ebde070
#SYMVER kiocb_write_and_wait 0x0f83eba5
#SYMVER kiocb_invalidate_pages 0xf23bfc92
#SYMVER generic_file_read_iter 0xc3b6ca6e
#SYMVER filemap_splice_read 0x8d6da810
#SYMVER filemap_fault 0xca55ed46
#SYMVER filemap_map_pages 0xb9e5c523
#SYMVER filemap_page_mkwrite 0x71b78b51
#SYMVER generic_file_mmap 0x246c4fac
#SYMVER generic_file_mmap_prepare 0xc11b9ed2
#SYMVER generic_file_readonly_mmap 0x0f7f8145
#SYMVER generic_file_readonly_mmap_prepare 0xc8170dde
#SYMVER read_cache_folio 0x76036e93
#SYMVER mapping_read_folio_gfp 0xfefdf713
#SYMVER read_cache_page 0x54e6918f
#SYMVER read_cache_page_gfp 0x83d71ec0
#SYMVER generic_file_direct_write 0x086a43a7
#SYMVER generic_perform_write 0x0326b05f
#SYMVER __generic_file_write_iter 0x0e294c28
#SYMVER generic_file_write_iter 0x0a836a12
#SYMVER filemap_release_folio 0x1e2c3f88
#SYMVER filemap_invalidate_inode 0x30b5d3fc
