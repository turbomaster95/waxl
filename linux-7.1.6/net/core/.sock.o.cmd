...
$(deps_net/core/sock.o):
#SYMVER sk_ns_capable 0x103dec75
#SYMVER sk_capable 0x85be20c6
#SYMVER sk_net_capable 0xddaa530e
#SYMVER sysctl_wmem_max 0xfac8865f
#SYMVER sysctl_rmem_max 0xb05fc310
#SYMVER memalloc_socks_key 0x877ec9fc
#SYMVER sk_set_memalloc 0x3765ab60
#SYMVER sk_clear_memalloc 0x5cfa8c83
#SYMVER __sk_backlog_rcv 0x02ac45d3
#SYMVER sk_error_report 0x52b520f0
#SYMVER sock_get_timeout 0xedd17b31
#SYMVER sock_copy_user_timeval 0x5bdb7603
#SYMVER __sock_queue_rcv_skb 0x74d0d0b5
#SYMVER sock_queue_rcv_skb_reason 0x1f5487d0
#SYMVER __sk_receive_skb 0x322a538a
#SYMVER __sk_dst_check 0xd8c09448
#SYMVER sk_dst_check 0xa5630b21
#SYMVER sock_bindtoindex 0xdc827671
#SYMVER sk_mc_loop 0x8fb34ace
#SYMVER sock_set_reuseaddr 0xe90453f6
#SYMVER sock_set_reuseport 0xc8bf6922
#SYMVER sock_no_linger 0x0f5b3356
#SYMVER sock_set_priority 0xdc2773b5
#SYMVER sock_set_sndtimeo 0xd4142a77
#SYMVER sock_set_keepalive 0x9de52fd3
#SYMVER sock_set_rcvbuf 0xa7b0f6d9
#SYMVER sock_set_mark 0xc626a1f9
#SYMVER sockopt_lock_sock 0xd4b1af85
#SYMVER sockopt_release_sock 0x7e950899
#SYMVER sockopt_ns_capable 0x99b4089c
#SYMVER sockopt_capable 0x2a6a5aac
#SYMVER sock_setsockopt 0xa747d168
#SYMVER sk_alloc 0x64dbb31d
#SYMVER sk_net_refcnt_upgrade 0xe44f2c32
#SYMVER sk_free 0xe2ca0f4b
#SYMVER sk_clone 0x20316d7f
#SYMVER sk_setup_caps 0x1e13da36
#SYMVER sock_wfree 0xccb7eb72
#SYMVER skb_set_owner_w 0x623a3210
#SYMVER skb_orphan_partial 0xda475553
#SYMVER sock_rfree 0x73ef2e51
#SYMVER sock_efree 0x3f078ec0
#SYMVER sock_wmalloc 0xc939d950
#SYMVER sock_kmalloc 0xed5e7dc5
#SYMVER sock_kmemdup 0x3aa934ab
#SYMVER sock_kfree_s 0xe5cb2d40
#SYMVER sock_kzfree_s 0xa3e283b5
#SYMVER sock_alloc_send_pskb 0x194c9fd4
#SYMVER __sock_cmsg_send 0xbe687b3c
#SYMVER sock_cmsg_send 0xc982b564
#SYMVER skb_page_frag_refill 0x6e6d3b56
#SYMVER sk_page_frag_refill 0x56c150fe
#SYMVER __sk_flush_backlog 0x4ac97bcf
#SYMVER sk_wait_data 0xd3162bc3
#SYMVER __sk_mem_schedule 0xeabbbf83
#SYMVER __sk_mem_reclaim 0xe504ddf7
#SYMVER sk_set_peek_off 0xb23e40f3
#SYMVER sock_no_bind 0xe30274b4
#SYMVER sock_no_connect 0xc0408fb9
#SYMVER sock_no_socketpair 0xff3afa96
#SYMVER sock_no_accept 0xbf800e52
#SYMVER sock_no_getname 0xa6e44eef
#SYMVER sock_no_ioctl 0xe422f552
#SYMVER sock_no_listen 0x6c1599b0
#SYMVER sock_no_shutdown 0x662cb0a4
#SYMVER sock_no_sendmsg 0x56731c36
#SYMVER sock_no_sendmsg_locked 0x324870ae
#SYMVER sock_no_recvmsg 0x4d9f07a7
#SYMVER sock_no_mmap 0xece3af65
#SYMVER sk_send_sigurg 0x1f8f179c
#SYMVER sk_reset_timer 0x541c8922
#SYMVER sk_stop_timer 0xdcbc7911
#SYMVER sk_stop_timer_sync 0xa1de6bca
#SYMVER sock_init_data_uid 0x6ab80a5a
#SYMVER sock_init_data 0xc0481e94
#SYMVER lock_sock_nested 0xa612659a
#SYMVER release_sock 0xe288538b
#SYMVER __lock_sock_fast 0xef80f11b
#SYMVER sock_gettstamp 0xdf4b154b
#SYMVER sock_recv_errqueue 0xc5b39e1d
#SYMVER sock_common_getsockopt 0x70a61641
#SYMVER sock_common_recvmsg 0x88da8bda
#SYMVER sock_common_setsockopt 0x59869f60
#SYMVER sk_common_release 0x37b702c6
#SYMVER sock_prot_inuse_get 0xf27eade5
#SYMVER sock_inuse_get 0x93d3aaea
#SYMVER proto_register 0x07ca7da8
#SYMVER proto_unregister 0xa281e505
#SYMVER sock_load_diag_module 0xf665f74f
#SYMVER sk_busy_loop_end 0xe590dea3
#SYMVER sock_bind_add 0x99ad408c
#SYMVER sock_ioctl_inout 0x25fd168e
#SYMVER sk_ioctl 0xe78b6acd
