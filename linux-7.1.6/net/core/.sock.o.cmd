...
$(deps_net/core/sock.o):
#SYMVER sk_ns_capable 0x9617ff73
#SYMVER sk_capable 0x8de55138
#SYMVER sk_net_capable 0x3ac16524
#SYMVER sysctl_wmem_max 0xfac8865f
#SYMVER sysctl_rmem_max 0xb05fc310
#SYMVER memalloc_socks_key 0x877ec9fc
#SYMVER sk_set_memalloc 0x88b8d5a2
#SYMVER sk_clear_memalloc 0x429427b1
#SYMVER __sk_backlog_rcv 0x893600d8
#SYMVER sk_error_report 0xd6ba703a
#SYMVER sock_get_timeout 0xedd17b31
#SYMVER sock_copy_user_timeval 0x5bdb7603
#SYMVER __sock_queue_rcv_skb 0x146d9803
#SYMVER sock_queue_rcv_skb_reason 0xd1a6a8e3
#SYMVER __sk_receive_skb 0x4ce4e483
#SYMVER __sk_dst_check 0xf01c034c
#SYMVER sk_dst_check 0x3167f6cc
#SYMVER sock_bindtoindex 0xc1d73670
#SYMVER sk_mc_loop 0x87506872
#SYMVER sock_set_reuseaddr 0x46f5d060
#SYMVER sock_set_reuseport 0x1c206cb4
#SYMVER sock_no_linger 0x87250441
#SYMVER sock_set_priority 0xbe81f982
#SYMVER sock_set_sndtimeo 0xbf160310
#SYMVER sock_set_keepalive 0x780855e8
#SYMVER sock_set_rcvbuf 0x6e14374d
#SYMVER sock_set_mark 0x8ff89e5b
#SYMVER sockopt_lock_sock 0xa97c9f40
#SYMVER sockopt_release_sock 0x5632059b
#SYMVER sockopt_ns_capable 0x77ffdd9a
#SYMVER sockopt_capable 0x2a6a5aac
#SYMVER sock_setsockopt 0xf5d13c16
#SYMVER sk_alloc 0x03258375
#SYMVER sk_net_refcnt_upgrade 0xd4c5989c
#SYMVER sk_free 0x05d233fa
#SYMVER sk_clone 0x483bad62
#SYMVER sk_setup_caps 0xa27faf08
#SYMVER sock_wfree 0x25d15447
#SYMVER skb_set_owner_w 0xc242ec02
#SYMVER skb_orphan_partial 0x32ce05ca
#SYMVER sock_rfree 0xd5861e17
#SYMVER sock_efree 0xf20bfde5
#SYMVER sock_wmalloc 0x8e711a6c
#SYMVER sock_kmalloc 0xb4ba6103
#SYMVER sock_kmemdup 0x8c542598
#SYMVER sock_kfree_s 0x8651073e
#SYMVER sock_kzfree_s 0x8af717cb
#SYMVER sock_alloc_send_pskb 0x6ff023dd
#SYMVER __sock_cmsg_send 0x13da8c31
#SYMVER sock_cmsg_send 0xd89a9b59
#SYMVER skb_page_frag_refill 0xd40ff0e4
#SYMVER sk_page_frag_refill 0x4e58a948
#SYMVER __sk_flush_backlog 0xeffaee3c
#SYMVER sk_wait_data 0x3d34f296
#SYMVER __sk_mem_schedule 0x265df377
#SYMVER __sk_mem_reclaim 0xaa038053
#SYMVER sk_set_peek_off 0xa4e9feb4
#SYMVER sock_no_bind 0x1c7228be
#SYMVER sock_no_connect 0x4ef4d437
#SYMVER sock_no_socketpair 0x7533fbe5
#SYMVER sock_no_accept 0xd2d224af
#SYMVER sock_no_getname 0x93ac3e7b
#SYMVER sock_no_ioctl 0xd1a6ab63
#SYMVER sock_no_listen 0x50e5aede
#SYMVER sock_no_shutdown 0x89a39fdf
#SYMVER sock_no_sendmsg 0x2d47e89a
#SYMVER sock_no_sendmsg_locked 0x46b6fc33
#SYMVER sock_no_recvmsg 0x23e3cc62
#SYMVER sock_no_mmap 0xfd9bb30d
#SYMVER sk_send_sigurg 0xb0d2b2f6
#SYMVER sk_reset_timer 0x5a1b4192
#SYMVER sk_stop_timer 0x918f96ae
#SYMVER sk_stop_timer_sync 0x5baabcdb
#SYMVER sock_init_data_uid 0x8c29615d
#SYMVER sock_init_data 0xd00c34d0
#SYMVER lock_sock_nested 0xfab31b9a
#SYMVER release_sock 0xf85e0a22
#SYMVER __lock_sock_fast 0xf1f2d960
#SYMVER sock_gettstamp 0xb9dbad82
#SYMVER sock_recv_errqueue 0x43727b40
#SYMVER sock_common_getsockopt 0x61d2c8ba
#SYMVER sock_common_recvmsg 0xc2d0cd42
#SYMVER sock_common_setsockopt 0x0a235e14
#SYMVER sk_common_release 0x3963beda
#SYMVER sock_prot_inuse_get 0xe393f3f7
#SYMVER sock_inuse_get 0x59b89736
#SYMVER proto_register 0x9800e67d
#SYMVER proto_unregister 0x5ca7bb8f
#SYMVER sock_load_diag_module 0xf665f74f
#SYMVER sk_busy_loop_end 0xe590dea3
#SYMVER sock_bind_add 0xc88808c3
#SYMVER sock_ioctl_inout 0xdce51db2
#SYMVER sk_ioctl 0x7e61679b
