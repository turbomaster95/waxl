...
$(deps_net/socket.o):
#SYMVER sock_alloc_file 0x2d3edb40
#SYMVER sock_from_file 0x87516b41
#SYMVER sockfd_lookup 0xe95cd927
#SYMVER sock_alloc 0x1926696f
#SYMVER sock_release 0xa4850de7
#SYMVER __sock_tx_timestamp 0x35f01dd5
#SYMVER sock_sendmsg 0xb797ce4d
#SYMVER kernel_sendmsg 0x0899b9a3
#SYMVER __sock_recv_timestamp 0xc97c098c
#SYMVER __sock_recv_wifi_status 0x05f4cdf2
#SYMVER __sock_recv_cmsgs 0x996ed0a8
#SYMVER sock_recvmsg 0xd8178c5e
#SYMVER kernel_recvmsg 0x307bda83
#SYMVER brioctl_set 0x94eee9d3
#SYMVER vlan_ioctl_set 0xfbd0c741
#SYMVER sock_create_lite 0xfa5b707c
#SYMVER sock_wake_async 0xb2f41df5
#SYMVER __sock_create 0xd5b8fd8e
#SYMVER sock_create 0xfd8efb56
#SYMVER sock_create_kern 0xa33272b7
#SYMVER do_sock_setsockopt 0xa62b21af
#SYMVER do_sock_getsockopt 0xd6969ea2
#SYMVER sock_register 0x30d66386
#SYMVER sock_unregister 0x62737e1d
#SYMVER get_user_ifreq 0x33fc2a31
#SYMVER put_user_ifreq 0x38f48af7
#SYMVER kernel_bind 0xd0c35b13
#SYMVER kernel_listen 0xe8c185b0
#SYMVER kernel_accept 0xa9b1ef50
#SYMVER kernel_connect 0x564aca31
#SYMVER kernel_getsockname 0x27e1cd49
#SYMVER kernel_getpeername 0x0c904c8a
#SYMVER kernel_sock_shutdown 0x60df76bd
#SYMVER kernel_sock_ip_overhead 0x18c6b4b1
